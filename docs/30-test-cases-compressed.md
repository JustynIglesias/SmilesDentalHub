...
**Test Execution date:** ____________________  
**Description:** Verify that an authorized dentist or admin can successfully update a patient's dental record.  
**Pre-Conditions:** Authorized user is logged in and a patient dental record already exists.
...
| 3 | Update a tooth status or dental note. | Tooth `#18`, Status: `Fillings` | The selected input is changed successfully in the form. | ____________________ | ______ |
| 4 | Click **Save Dental Record**. | N/A | The system saves the updated dental record and displays success feedback. | ____________________ | ______ |
...
**Test Execution date:** ____________________  
**Description:** Verify that service amount, quantity, discount, and total computation are processed correctly before saving.  
...
| 3 | Enter service details including quantity, amount, and discount. | Service: `Tooth Cleaning`, Quantity: `2`, Amount: `1000`, Discount: `10%` | The system computes subtotal, discount, and final total automatically. | ____________________ | ______ |
| 4 | Review the computed values and save the record. | Expected Total: `1800` | The record is saved successfully after confirmation. | ____________________ | ______ |
| 5 | Review the service history list. | N/A | The new service record appears in the patient's service history. | ____________________ | ______ |
